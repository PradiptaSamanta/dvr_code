module InputData
  ...
  integer  :: m(2), m1, m2, nl, nr, l_max, z, n_max(2), two_e_int, nfrz
  logical  :: mapped_grid, only_bound, dvr_diag, dvr_integrals, trans_integrals, orbital_ints, split_grid, shift_int
